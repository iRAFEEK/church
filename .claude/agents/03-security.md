...
- **Tests exist:** the repo has ~1,120 vitest tests across ~73 files (incl. privilege-escalation + authz tests). Factor existing coverage into your findings — flag under-tested areas, never claim the repo is untested.
